...
import me.earthme.millacat.replacement.SynchronizedForgeEventBus;
...
public class MinecraftForge
{
     ...
     */
    public static final IEventBus EVENT_BUS = new SynchronizedForgeEventBus(BusBuilder.builder().startShutdown().build());
